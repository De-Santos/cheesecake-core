...
public interface PhotoApi {
    @Operation(summary = "Upload photo in database",
            description = "Upload selected photo in database and return photo id")
    @ApiResponses(value = {
    ...
    @Operation(summary = "Return list of photos",
            description = "Return list of all photos in database")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Successful operation")
    })
    @ResponseStatus(HttpStatus.OK)
    ...
    @Operation(summary = "Delete photo by id",
            description = "Delete photo from database by id")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Successful operation"),
            @ApiResponse(responseCode = "400", description = "Error in supplied file id"),
    })
